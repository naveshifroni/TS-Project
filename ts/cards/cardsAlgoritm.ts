...
const btnPlayer1 = document.getElementById("player1") as HTMLDivElement;
const btnPlayer2 = document.getElementById("player2") as HTMLDivElement;
const card1 = document.getElementById("card1") as HTMLDivElement;
const card2 = document.getElementById("card2") as HTMLDivElement;
let card1ForReal: (string | number)[] = [];
let card2ForReal: (string | number)[] = [];
let win1: (string | number)[] = [];
let win2: (string | number)[] = [];
let winWarArr: (string | number)[] = [];// מערך שנמלא במקרה של מלחמה (כששני הקלפים שווים)

const pack1 = document.getElementById("pack-1-display") as HTMLDivElement;
const pack2 = document.getElementById("pack-2-display") as HTMLDivElement;

let fullPackNum: number[] = [];
...
ranks.forEach(function (rank) {// נייצר מערך של סטרינגים של קלפים
...
function fillWarArr() { // נייצר פונקציה שתייצר לנו מערך לשימוש במקרה של מלחמה
...
function war() {// פונקציה שתרוץ במקרה של מלחמה
  fillWarArr();
